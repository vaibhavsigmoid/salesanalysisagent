...
cursor.execute("DROP TABLE IF EXISTS pos_raw_sales")
cursor.execute(
    """
    CREATE TABLE pos_raw_sales (
        sales_id INT,
        product_id INT,
        store_id INT,
...
print("Data inserted into 'pos_raw_sales' table in MySQL.")
